...
export type AtomInputCheckbox = ViewProps & {
  formik?: FormikValues;
  value?: boolean;
...
const AtomInputCheckbox = (props: AtomInputCheckbox) => {
  const {
    setChecked,
    colorChecked,
    colorBoxChecked,
  ...
  return (
    <AtomWrapper flexDirection="row" customCSS={wrapperCSS}>
      <Pressable
        {...inputCSS}
        disabled={disabled}
...
export default AtomInputCheckbox;
