...
const AtomModal: FC<AtomModalType> = (props) => {
  const { isOpen, modalProps, component } = props;
  const colorScheme = useColorScheme();
  return (
    <Modal visible={isOpen} transparent={true} animationType="slide" {...modalProps}>
      <AtomWrapper
        style={{
          flex: 1,
        }}
        ...
        alignItems='center'
        backgroundColor={`${colorScheme !== 'dark' ? '#ffffffd6' : '#000000d7'}`}
      >
        {/* <AtomWrapper
          alignItems="center"
          justifyContent="center"
